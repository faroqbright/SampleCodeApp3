    ...
    render() {
        ...
        return (
            <TouchableOpacity
                ...
                style={[styles.inputContainer, inputContainer,{borderColor: isFocused ? 'black' : '#F5F6FA'}]}>
                {leftComponent ?
                    leftComponent
                    :
                    leftIcon &&
                ...
                <TextInput
                    ...
                    style={[styles.inputStyle, inputStyle,{color:isFocused?'#00B3EC' : '#00B3EC', fontFamily:'Avenir Heavy'}]}
                    value={value}
